...
Last updated 2026-07-28 (M0 backend complete).
...
| API contract | ✅ Committed | `docs/api/openapi.yaml` + 9 fixtures, generated by `backend/tools/make_contract.py` |
| Backend tests | ✅ Running | `backend/tests/` — 24 tests on a throwaway DB (`pytest` from `backend/`) |
...
| Chat, Places, history | ❌ Not started | — |
